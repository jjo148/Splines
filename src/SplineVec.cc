...
namespace Splines
{
    ...
    SplineVec::SplineVec (string const& name)
      : _name (name), baseValue (name + "_values"), basePointer (name + "_pointers"), _dim (0), _npts (0), _check_range (true), _X (nullptr), _Y (nullptr), _Yp (nullptr), lastInterval (0)
    {
    }
        ...
        SplineVec::operator() (real_type x, integer j) const
    {
        ...
        return base[0] * _Y[size_t (j)][i] + base[1] * _Y[size_t (j)][i + 1] + base[2] * _Yp[size_t (j)][i] + base[3] * _Yp[size_t (j)][i + 1];
    }
        ...
        SplineVec::D (real_type x, integer j) const
    {
        ...
        return base_D[0] * _Y[size_t (j)][i] + base_D[1] * _Y[size_t (j)][i + 1] + base_D[2] * _Yp[size_t (j)][i] + base_D[3] * _Yp[size_t (j)][i + 1];
    }
        ...
        SplineVec::DD (real_type x, integer j) const
    {
        ...
        return base_DD[0] * _Y[size_t (j)][i] + base_DD[1] * _Y[size_t (j)][i + 1] + base_DD[2] * _Yp[size_t (j)][i] + base_DD[3] * _Yp[size_t (j)][i + 1];
    }
        ...
        SplineVec::DDD (real_type x, integer j) const
    {
        ...
        return base_DDD[0] * _Y[size_t (j)][i] + base_DDD[1] * _Y[size_t (j)][i + 1] + base_DDD[2] * _Yp[size_t (j)][i] + base_DDD[3] * _Yp[size_t (j)][i + 1];
    }
                         ...
                         integer inc) const
    {
        ...
        for (size_t j = 0; j < size_t (_dim); ++j, v += inc)
            *v = base[0] * _Y[j][i] + base[1] * _Y[j][i + 1] + base[2] * _Yp[j][i] + base[3] * _Yp[j][i + 1];
    }
                           ...
                           integer inc) const
    {
        ...
        real_type* v = vals;
        for (size_t j = 0; j < size_t (_dim); ++j, v += inc)
            *v = base_D[0] * _Y[j][i] + base_D[1] * _Y[j][i + 1] + base_D[2] * _Yp[j][i] + base_D[3] * _Yp[j][i + 1];
    }
                            ...
                            integer inc) const
    {
        ...
        real_type* v = vals;
        for (size_t j = 0; j < size_t (_dim); ++j, v += inc)
            *v = base_DD[0] * _Y[j][i] + base_DD[1] * _Y[j][i + 1] + base_DD[2] * _Yp[j][i] + base_DD[3] * _Yp[j][i + 1];
    }
                             ...
                             integer inc) const
    {
        ...
        real_type* v = vals;
        for (size_t j = 0; j < size_t (_dim); ++j, v += inc)
            *v = base_DDD[0] * _Y[j][i] + base_DDD[1] * _Y[j][i + 1] + base_DDD[2] * _Yp[j][i] + base_DDD[3] * _Yp[j][i + 1];
    }
